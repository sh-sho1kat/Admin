package com.example.admin.adminpart.departments.facultymembers;
...
public class AddDepartmentFaculty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_department_faculty);
        ...
        String[] items = new String[]{"Select Catagory","Head Of Department","Faculty Members"};
        ...
        addTeacher.setOnClickListener(new View.OnClickListener() {
            ...
            private void checkValidation() {
                ...
                {
                    Toast.makeText(AddDepartmentFaculty.this, "Please Select Catagory", Toast.LENGTH_SHORT).show();
                }
                else if(bitmap==null)
                {
            ...
            private void uploadData() {
                ref = reference.child(dept).child(catagory);
                ...
                ref.child(uniquekey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AddDepartmentFaculty.this, "Teacher Added Successfully", Toast.LENGTH_SHORT).show();
                        PB.dismiss();
                        finish();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AddDepartmentFaculty.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                        PB.dismiss();
                    }
                });
            }
            ...
            private void uploadImage() {
                ...
                filepath =  storageReference.child(dept).child(catagory).child(finalimg+"jpg");
                final UploadTask uploadTask = filepath.putBytes(finalimg);
                uploadTask.addOnCompleteListener(AddDepartmentFaculty.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    @Override
